...
const Footer = () => (
  ...
  >
    <p className="text-gray-600 text-sm">
      &copy; 2014 - 2020 Saúl Solórzano. Potenciado con <Link>Gatsby</Link>
      <br />
      Hospedado en{" "}
      <Link
        to="http://www.netlify.com/"
    ...
    <nav className="flex space-x-4">
      <Link to="http://twitter.com/saulsolorzano">
        <svg
      ...
      <Link to="https://github.com/saulsolorzano">
        <svg
          className="h-4 w-4 text-gray-400 hover:text-yellow-700"
          fill="currentColor"
          xmlns="http://www.w3.org/2000/svg"
      ...
      <Link to="mailto:hola@saulsolorzano.com">
        <svg
          className="h-4 w-4 text-gray-400 hover:text-yellow-700"
          fill="currentColor"
          xmlns="http://www.w3.org/2000/svg"
